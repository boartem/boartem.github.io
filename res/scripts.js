...
function setcolor_1() {
    ...
    root.style.setProperty(' --body_bgcolor', '#e60000');
    root.style.setProperty('--link', '#d3d3d3');
    root.style.setProperty('--alink', '#e60000');
    root.style.setProperty('--flink', '#e60000');
    root.style.setProperty('--hlink', '#e60000');
    root.style.setProperty('--vlink', '#d3d3d3');
    root.style.setProperty('--dlink_bg', '#e60000');
    root.style.setProperty('--dlink_abg', '#fd1340');
    root.style.setProperty('--dlink_fbg', '#fd1340');
    root.style.setProperty('--dlink_hbg', '#fd1340');
    root.style.setProperty('--dlink_vbg', '#e60000');
    root.style.setProperty('--contentcolor', '#e60000');
...
function setcolor_2() {
    ...
    root.style.setProperty('--dlink_abg', '#e60000');
    root.style.setProperty('--dlink_fbg', '#e60000');
    root.style.setProperty('--dlink_hbg', '#e60000');
